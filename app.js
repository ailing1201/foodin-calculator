...
const categories = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'v4', name: '店內電視牆版 (30秒)', price: 4800, desc: '動態展示 (5-6道菜)' },
      { id: 'v5', name: '店內電視牆版 (60秒)', price: 6500, desc: '動態展示 (7-10道菜)' },
  ...
  },
  {
    ...
    items: [
      { id: 'ps1', name: 'A4 海報設計', price: 1200, desc: '適合店內小型公告' },
      { id: 'ps2', name: 'A3 海報設計', price: 1800, desc: '適合店內主要視覺' },
      { id: 'ps3', name: 'A2/A1 大型海報設計', price: 2500, desc: '適合落地立牌、戶外看板' },
    ]
  },
  {
    id: 'addon',
